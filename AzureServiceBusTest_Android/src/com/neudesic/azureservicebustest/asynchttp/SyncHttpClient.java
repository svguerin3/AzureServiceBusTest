package com.neudesic.azureservicebustest.asynchttp;

import com.neudesic.azureservicebustest.asynchttp.*;
import com.neudesic.azureservicebustest.asynchttp.AsyncHttpRequest;
...
public abstract class SyncHttpClient extends com.neudesic.azureservicebustest.asynchttp.AsyncHttpClient {
	...
	protected com.neudesic.azureservicebustest.asynchttp.AsyncHttpResponseHandler responseHandler = new com.neudesic.azureservicebustest.asynchttp.AsyncHttpResponseHandler() {
    ...
    protected void sendRequest(DefaultHttpClient client,
			...
			String contentType, com.neudesic.azureservicebustest.asynchttp.AsyncHttpResponseHandler responseHandler,
			Context context) {
		if (contentType != null) {
		 ...
		 */
		new com.neudesic.azureservicebustest.asynchttp.AsyncHttpRequest(client, httpContext, uriRequest, responseHandler)
				.run();
	}

	public abstract String onRequestFailed(Throwable error, String content);

	public void delete(String url, com.neudesic.azureservicebustest.asynchttp.RequestParams queryParams,
			AsyncHttpResponseHandler responseHandler) {
		// TODO what about query params??
		delete(url, responseHandler);
	}

	public String get(String url, com.neudesic.azureservicebustest.asynchttp.RequestParams params) {
	...
	public String put(String url, com.neudesic.azureservicebustest.asynchttp.RequestParams params) {
	...
	public String post(String url, com.neudesic.azureservicebustest.asynchttp.RequestParams params) {
